...
/// Raw TMDB movie-detail JSON (Star Wars) used for previews and tests.
let sampleMovieDetailJSON = Data("""
{
  "adult": false,
...
public extension MovieDetail {
    /// A decoded sample for previews.
    static let sample = try! JSONDecoder().decode(MovieDetail.self, from: sampleMovieDetailJSON)
}
#endif
